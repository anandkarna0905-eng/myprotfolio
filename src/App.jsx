              ...
              <div className="timeline">
                  {/* <div className="timeline-item">
                      ...
                      <div className="timeline-content glass-card">
                          ...
                          <p>Leading development of enterprise-level applications using React, Node.js, and cloud technologies. Mentoring junior developers and architecting scalable solutions.</p>
                      </div>
                  </div>
                  <div className="timeline-item">
                      ...
                      <div className="timeline-content glass-card">
                          ...
                          <p>Developed and maintained multiple web applications. Implemented CI/CD pipelines and optimized application performance by 40%.</p>
                      </div>
                  </div> */}
                  <div className="timeline-item">
      ...
      <section id="contact">
          ...
          <div className="contact-container">
              ...
              <div className="social-links">
                  <a href="https://github.com" target="_blank" className="social-icon" title="GitHub">🐙</a>
                  <a href="https://linkedin.com" target="_blank" className="social-icon" title="LinkedIn">💼</a>
                  <a href="https://twitter.com" target="_blank" className="social-icon" title="Twitter">🐦</a>
                  <a href="mailto:anandkarna0905@gmail.com" className="social-icon" title="Email">📧</a>
              </div>
          </div>
      </section>
